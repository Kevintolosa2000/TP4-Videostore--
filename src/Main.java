...
//        Consola.escribir(nombreCliente); //Me perdi necesito si o no esto onda funciona igual sin esto 
...
//        Consola.escribir(tituloPelicula);


        roberto.alquilarPelicula(nombreCliente, tituloPelicula);//ALQUILAR PELICULA

        System.out.println(roberto.toString());
        //ESTE MUESTRA TODO COMO SI FUERAS EL DUEÑO SI QUERES VER MENOS USAR EL DE LA CLASE ALQUILER
    }
}
